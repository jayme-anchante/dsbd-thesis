...
Os algoritmos preditivos implementados pela plataforma são: regressão linear, elasticnet (uma regressão linear com regularização L1 e L2), florestas aleatórias, $k$ vizinhos próximos, rede neural profunda, implementados pela biblioteca \textit{scikit-learn}\cite{Pedregosa}; um algoritmo de impulso de gradiente extremo baseado em árvore de decisão com \textit{boosting} chamado de XGBoost\cite{Chen}.
...
\bibitem{Chen} CHEN, T.; GUESTRIN, C. (2016). XGBoost: A Scalable Tree Boosting System. In: PROCESSIDINGS OF THE 22nd ACM SIGKDD INTERNACIONAL CONFERENCE ON KNOWLEDGE DISCOVERY AND DATA MINING. São Francisco. \textit{Anais}... São Francisco, CA, USA: ACM, 13-17 Agosto de 2016. p. 785–794. arXiv:1603.02754.
